...
async def main():
    async with TelegramClient(StringSession(SESSION), API_ID, API_HASH) as client:
        ...
        exported = await client(ExportChatInviteRequest(peer=chat_obj, title="Enlace Privado Series Retro y Clásicas"))
        ...
        print("Configuración actualizada en config_supergrupos_series.json!")
